  ...
  function addEvent(){
    ...
    for(i=0;i<=uls.length;i++){
        uls[i].onclick=function(){
            var lis =this.getElementsByClassName('listcontent');
			var titleopen=this.getElementsByClassName('titleopen')[0]; 
			var titleclose=this.getElementsByClassName('titleclose')[0]; 
			if(x==0){
			    titleclose.style.display='none';
                titleopen.style.display='block';
			...
			x=1;
				...
				titleclose.style.display='block';
                titleopen.style.display='none';
			for(var i=0 ;i<lis.length;i++){
	...
	function changetohomepage()
	{
		...
		document.getElementById("page").style.color='#4a8ac7';
		document.getElementById("class").style.color='#000000';
		document.getElementById("discussarea").style.color='#000000';
	}
	
	//课程
	function changetoclass()
	{
		//var homepage=getElementById(homepage);
		document.getElementById("homepage").style.display='none';
		document.getElementById("course").style.display='block';
		document.getElementById("discuss").style.display='none';
		document.getElementById("page").style.color='#000000';
		document.getElementById("class").style.color='#4a8ac7';
		document.getElementById("discussarea").style.color='#000000';
	}
	
	//讨论区
	function changetodiscuss()
	{
		document.getElementById("homepage").style.display='none';
		document.getElementById("course").style.display='none';
		...
		document.getElementById("page").style.color='#000000';
		document.getElementById("class").style.color='#000000';
		document.getElementById("discussarea").style.color='#4a8ac7';
	}
